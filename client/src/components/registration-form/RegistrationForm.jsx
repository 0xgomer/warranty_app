        ...
        <div className='registration-form' onClick={() => setRegistrationForm(false)}>
            <form className="registration-form__content" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="registration-form__header">
                    <h1>sign in</h1>
                    <p>Already a user? <span onClick={changeForm}>log in</span></p>
                </div>
                <div className="registration-form__input">
                    ...
                    <InputText name={'Confirm password'} type={'password'} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}/>
                </div>
                <Button type={'primary'} onClick={(e) => registrationFormHandler(e)}>sign in</Button>
