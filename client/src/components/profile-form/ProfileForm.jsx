    ...
    return (
        <div className='profile-form'>
            <div className="profile-form__header">
                <h1>Profile</h1>
                <p>You can change your profile settings</p>
            </div>
            <div className="profile-form__forms">
                <div className="profile-form__form">
                    <strong>Username</strong>
                    <InputButton btnText={'Edit'} onClick={changeUsernameHandler} value={username || ''} onChange={(e) => setUsername(e.target.value)}/>
                </div>
                <div className="profile-form__form">
                    <strong>Email</strong>
                    <InputButton btnText={'Edit'} onClick={changeEmailHandler} value={email || ''} onChange={(e) => setEmail(e.target.value)}/>
                </div>
            </div>
